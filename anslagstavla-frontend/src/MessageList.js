...
//   const [filterByUsername, setFilterByUsername] = useState(''); // Håller reda på det valda användarnamnet för filtrering
...
//   const filterMessagesByUsername = (username) => {
//     if (username === filterByUsername) {

//       setFilteredMessages(messages);
//       setFilterByUsername('');
//     } else {
//       const filtered = messages.filter((msg) => msg.username === username);
...
//       <button className="sort-button" onClick={sortMessagesByDate}>Sort by Date</button> {/* Sorteringsknapp */}
//       <ul className="message-list">
//         {filteredMessages.map(message => (
//           <li key={message.id} onClick={() => handleSelectMessage(message)} className="message-item">
//             <p className="message-text" style={{ cursor: 'pointer', color: filterByUsername === message.username  }}>{message.text} </p> {/* Meddelandet visas här */}
//             <p 
//               className="message-username" 
//               onClick={(e) => {
//                 e.stopPropagation(); 
//                 filterMessagesByUsername(message.username);
//               }}
//               style={{ cursor: 'pointer', color: filterByUsername === message.username ? 'blue' : 'black' }}
//             >
//               <strong>{message.username}</strong>
//             </p> {}
//             <p className="message-date">Posted at: {new Date(message.createdAt).toLocaleString()}</p> {}
//           </li>
//         ))}
//       </ul>
...
//       {selectedMessage && (
//         <div className="update-message-form" ref={formRef}> {}
...
//       {(filterByUsername || filteredMessages.length !== messages.length) && (
